...
const Hero = () => {
  ...
  <span className="text-[#f26161]">Eco-Friendly</span> Solutions for You
</h1>
<p className="text-white regular-20 mt-3 lg:mt-6 max-w-[36rem]">
  Discover the perfect way to refresh your home and lifestyle with innovative, eco-friendly products. Enjoy incredible deals that help you save energy while making a positive impact on the planet.
</p>
