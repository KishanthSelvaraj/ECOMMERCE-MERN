...
const AddProduct = () => {
  ...
  const AddProduct = async () => {
    ...
    try {
      const uploadResponse = await fetch("https://ecommerce-mern-w5oy.onrender.com/upload", {
        method: "POST",
        headers: {
      ...
      if (responseData.success) {
        ...
        console.log(product);
        const addProductResponse = await fetch("https://ecommerce-mern-w5oy.onrender.com/addproduct", {
          method: "POST",
          headers: {
            Accept: "application/json",
        ...
        if (addProductData.success) {
          ...
          notifyError("Product Upload Failed!");
        }
      } else {
    ...
    <div className="p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7">
      ...
      <div className="mb-3 flex items-center gap-x-4">
        ...
        <select
          ...
          name="category"
          id=""
          className="bg-primary ring-1 ring-slate-900/20 median-16 rounded-sm outline-none"
        >
